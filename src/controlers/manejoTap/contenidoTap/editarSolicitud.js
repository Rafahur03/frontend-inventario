...
const editarSolicitud = (id) => {
    ...
    seccion.innerHTML = `
        ...
        <div class="container-fluid w-100 d-flex mb-3 mt-3">
            ...
            <div class="ms-2">
                <button type="button" class="btn  mt-0 pt-0 elaborarReporte d-none"
                    title="elaborarReporte">
            ...
            <form class="container-fluid w-100 position-relative">
                <div class="row mx-3 align-items-center">
                    <div class="form-group col-4 p-4">
                        <div id="carouselExampleControls" class="carousel slide" ata-bs-ride="carousel">
                ...
                <div class="row m-2 align-items-center">
                    <div class="form-group col d-flex flex-column">
                        ...
                        <textarea class="form-control descripcionSolicitud" rows="4"
                            readonly></textarea>
                    </div>
                </div>
